...
namespace Diplom.Controllers
{
    ...
    public class SmartphoneController : CommonCRUDController
    {
        ...
        public SmartphoneController(ISimpleRepo<ChargingType> BrandRepository, ISimpleRepo<Department> DepRepository,
        ...
        public async Task<IActionResult> Save(Smartphone smartphone, IFormFile UploadFile)
        {
            if (UploadFile!=null)
            {
                smartphone.product.Photo = base.LoadPhoto(UploadFile, smartphone.product.Photo, "Smartphone");
            }
